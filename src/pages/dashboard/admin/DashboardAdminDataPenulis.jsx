import { PenulisTable } from "../../../components/tables/PenulisTable";
import { FaPlus } from 'react-icons/fa';

export function DashboardAdminDataPenulis() {
    return (
        <>
            <section>
                    ...
                    <div className="py-4">
                        <div className="gap-8 mr-8 p-6 bg-white rounded-xl shadow-md">
                            <div className='flex justify-between items-center'>
                                <div className="">
                                    <h1 className="poppins-semibold text-2xl text-[#0B497B]">Data Penulis</h1>
